...
public class DesconectarUsuario extends HttpServlet {
	...
	throws ServletException, IOException
	{
		...
		mdlUsuariosConectados.eliminarUsuarioConectadoByUid(sesion.usuario.uid);
		
		CookiesUtils cu = new CookiesUtils();
		HashMapCookie<String, String> mapaCookies = cu.createCookieMapFromArray("tresenraya", request.getCookies());
		...
		if (cookieRecordar != null && cookieRecordar.equals("true"))
		{
			...
			Cookie c = new Cookie("tresenraya", mapaCookies.toString());
